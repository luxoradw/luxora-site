...
<section className="mx-auto max-w-7xl px-6 pb-32">
  ...
  <div className="overflow-hidden border border-yellow-400/25 bg-white/[0.02] shadow-[0_30px_90px_rgba(0,0,0,0.65)]">
    <img
      src="/hardware-gallery.png"
      alt="Luxora Hardware Gallery"
