...
const features = [
  {
    title: "Adjustable Glass Blades",
    text: "Precision engineered louvre blades allow controlled airflow, daylight, and ventilation with modern architectural aesthetics.",
    icon: Wind,
  },
  {
    title: "Luxury Minimal Design",
    text: "Slim aluminum framing and clean sightlines create a sophisticated high-end architectural appearance.",
    icon: Layers3,
  },
  {
    title: "Natural Ventilation",
    text: "Optimized airflow performance improves indoor comfort while maintaining elegant visual transparency.",
    icon: SunMedium,
  },
  {
    title: "Premium Hardware System",
    text: "Heavy-duty concealed hardware ensures smooth movement, durability, and luxury operation feel.",
    icon: Eye,
  },
];

export default function GlassLouvreAboutPage() {
  return (
      ...
      <section className="relative mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-6 py-32 text-center">
        ...
        >
          ...
          <p className="mx-auto mt-10 max-w-3xl text-sm font-light leading-8 tracking-[0.08em] text-white/60 md:text-base">
            Luxora Glass Louvre systems combine luxury architectural aesthetics
            with advanced ventilation performance, creating elegant modern
            spaces filled with natural airflow, daylight, and premium visual
            transparency.
          </p>
        ...
        >
          <div className="relative overflow-hidden rounded-[36px] border border-yellow-500/20 bg-white/[0.03] p-8 backdrop-blur-xl">
            ...
            <div className="relative flex h-[340px] items-center justify-center md:h-[440px]">
              <div className="relative h-[80%] w-[75%] rounded-[24px] border border-yellow-500/20 bg-neutral-950 p-5">
                <div className="flex h-full flex-col justify-center gap-4">
                  {[1, 2, 3, 4, 5].map((item) => (
                    <motion.div
                      ...
                      className="relative h-10 overflow-hidden rounded-full border border-yellow-500/20 bg-gradient-to-r from-neutral-700 to-neutral-900"
                    >
                      <motion.div
                        animate={{ rotate: -10 }}
                        transition={{
                        ...
                        className="absolute inset-0 origin-left bg-gradient-to-r from-white/10 to-transparent"
                      />

                      <div className="absolute inset-y-0 right-0 w-[2px] bg-yellow-500/40" />
                    </motion.div>
                  ))}
                </div>

                <div className="absolute inset-0 flex items-center justify-center">
                  <Sparkles className="h-12 w-12 text-yellow-400/60" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative border-t border-white/10 py-28">
        <div className="mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
          ...
          <h2 className="mt-10 text-4xl font-extralight uppercase tracking-[0.14em]">
            Luxury Ventilation Experience
          </h2>

          <p className="mt-8 max-w-3xl text-sm leading-8 tracking-[0.06em] text-white/60">
            Luxora Glass Louvre systems are engineered using premium aluminum,
            architectural glazing, luxury finishes, and precision hardware to
            create elegant modern environments with maximum airflow and
