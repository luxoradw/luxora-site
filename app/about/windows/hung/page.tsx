...
const features = [
  {
    title: "Classic Vertical Operation",
    text: "Smooth vertical sliding functionality engineered for timeless luxury residential architecture.",
    icon: MoveVertical,
  },
  {
    title: "Premium Aluminum Framing",
    text: "Slim modern aluminum profiles provide elegant sightlines with structural durability.",
    icon: Layers3,
  },
  {
    title: "Thermal & Acoustic Comfort",
    text: "Insulated glazing systems improve energy efficiency and reduce exterior noise levels.",
    icon: SunMedium,
  },
  {
    title: "Weather Protection",
    text: "Advanced sealing systems provide protection against air infiltration, wind, and water.",
    icon: Wind,
  },
];

export default function HungWindowAboutPage() {
  return (
      ...
      <section className="relative mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-6 py-32 text-center">
        ...
        >
          ...
          <p className="mx-auto mt-10 max-w-3xl text-sm font-light leading-8 tracking-[0.08em] text-white/60 md:text-base">
            Luxora Hung Window systems combine timeless architectural elegance
            with modern engineering performance, creating sophisticated living
            spaces with smooth functionality, thermal comfort, and luxury
            aesthetics.
          </p>
        ...
        >
          <div className="relative overflow-hidden rounded-[36px] border border-yellow-500/20 bg-white/[0.03] p-8 backdrop-blur-xl">
            ...
            <div className="relative flex h-[340px] items-center justify-center md:h-[440px]">
              <div className="relative h-[85%] w-[40%] rounded-[24px] border border-yellow-500/20 bg-neutral-950 p-3">
                <div className="relative h-full w-full rounded-[18px] border border-white/10">
                  {/* top sash */}
                  <div className="absolute left-0 top-0 h-1/2 w-full border-b border-yellow-500/20 bg-gradient-to-b from-neutral-700 to-neutral-900">
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-0 left-0 h-1/2 w-full border-t border-yellow-500/20 bg-gradient-to-b from-neutral-700 to-neutral-950"
                  >
                    <div className="absolute inset-[10px] border border-white/10" />
                  </motion.div>
      ...
      <section className="relative border-t border-white/10 py-28">
        <div className="mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
          ...
          <p className="mt-8 max-w-3xl text-sm leading-8 tracking-[0.06em] text-white/60">
            Luxora Hung Window systems are crafted using premium-grade
            aluminum, luxury hardware, architectural glazing, and precision
            engineering for elegant modern residential environments.
          </p>
