...
const features = [
  {
    title: "Natural Daylight Experience",
    text: "Architectural skylight systems designed to maximize daylight and create bright luxury interior environments.",
    icon: SunMedium,
  },
  {
    title: "Minimal Aluminum Framing",
    text: "Slim premium aluminum profiles provide elegant modern aesthetics with clean architectural lines.",
    icon: Layers3,
  },
  {
    title: "Thermal Glass Technology",
    text: "Advanced insulated glazing improves energy efficiency while minimizing heat transfer.",
    icon: CloudSun,
  },
  {
    title: "Weather Protection",
    text: "Engineered sealing systems provide long-term protection against water infiltration and wind exposure.",
    icon: Wind,
  },
];

export default function SkylightAboutPage() {
  return (
      ...
      <section className="relative mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-6 py-32 text-center">
        ...
        >
          ...
          <p className="mx-auto mt-10 max-w-3xl text-sm font-light leading-8 tracking-[0.08em] text-white/60 md:text-base">
            Luxora Skylight systems are engineered to transform interiors with
            natural light, architectural elegance, and premium modern
            performance for luxury residential and commercial spaces.
          </p>
        ...
        >
          <div className="relative overflow-hidden rounded-[36px] border border-yellow-500/20 bg-white/[0.03] p-8 backdrop-blur-xl">
            ...
            <div className="relative flex h-[340px] items-center justify-center md:h-[440px]">
              {/* roof */}
              <div className="relative h-[70%] w-[80%] rotate-[-8deg] rounded-[28px] border border-yellow-500/20 bg-neutral-950 p-4">
                {/* glass */}
                <div className="relative h-full w-full overflow-hidden rounded-[22px] border border-white/10 bg-gradient-to-br from-neutral-700 to-neutral-950">
                  {/* reflections */}
                  <motion.div
                    animate={{
                      x: ["-120%", "120%"],
                    ...
                    className="absolute inset-y-0 w-1/3 skew-x-[-20deg] bg-white/10 blur-2xl"
                  />

                  <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/5 to-transparent" />

                  <div className="absolute inset-0 flex items-center justify-center">
                    <Sparkles className="h-14 w-14 text-yellow-400/70" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative border-t border-white/10 py-28">
        <div className="mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
          ...
          <h2 className="mt-10 text-4xl font-extralight uppercase tracking-[0.14em]">
            Luxury Natural Light
          </h2>

          <p className="mt-8 max-w-3xl text-sm leading-8 tracking-[0.06em] text-white/60">
            Luxora Skylight systems combine premium-grade aluminum,
            architectural insulated glass, luxury finishes, and precision
            engineering to create elegant naturally illuminated spaces.
          </p>
