  ...
  <div className="relative z-10 flex h-full items-center px-10 md:px-16">
    <div className="max-w-3xl">
      ...
      <p className="mt-6 max-w-xl text-lg text-white/75">
        Bring natural daylight into your space with premium skylight systems
        engineered for luxury architecture and energy efficiency.
      </p>
    </div>
  </div>
</section>
