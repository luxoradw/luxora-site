...
<section className="relative mb-16 h-[650px] overflow-hidden rounded-[30px] border border-white/10">
  <img
    src="/heavy.png"
    alt="Luxora Heavy Duty Sliding Door"
  ...
  <div className="relative z-10 flex h-full items-center px-10 md:px-16">
    <div className="max-w-3xl">
      ...
      <p className="mt-6 max-w-xl text-lg text-white/75">
        Engineered for oversized openings and massive glass panels,
        delivering exceptional strength, smooth operation,
        and panoramic architectural views.
      </p>
    </div>
  </div>
</section>
