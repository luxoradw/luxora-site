      ...
      <section className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-20 px-6 py-32 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-10 max-w-2xl text-sm leading-8 text-white/60 md:text-base">
            Thermal break lift sliding door system designed for wide glass
            openings, smooth heavy-panel movement, strong insulation, and luxury
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {[
              [
                "Operation",
                "Lift mechanism raises the panel slightly before sliding for smoother movement and better sealing.",
              ],
              [
                "Performance",
                "Thermal break construction supports insulated glass, air control, and improved comfort.",
              ],
              [
                "Design",
                "Designed for luxury wide openings with clean aluminum profiles and panoramic glass views.",
              ],
            ].map(([title, text]) => (
