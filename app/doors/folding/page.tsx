  ...
  <div className="relative z-10 flex h-full items-center px-10 md:px-16">
    <div className="max-w-3xl">
      ...
      <p className="mt-6 max-w-xl text-lg text-white/75">
        Transform entire walls into open living spaces with premium folding
        door systems, panoramic views, and seamless indoor-outdoor living.
      </p>
    </div>
  </div>
</section>
